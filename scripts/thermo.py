...
def get_electronic_energy(spc_info, geo_theory, sp_theory,
                          save_prefix, saddle=False):
    """ return electronic energy for specific species for given level of theory
    """
...
def get_spc_input(spc, spc_dct_i, spc_info, spc_save_path,
                  pf_levels, spc_model):
